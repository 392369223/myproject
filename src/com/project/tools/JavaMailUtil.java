...
public class JavaMailUtil {
    ...
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "392369223@qq.com";
    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "cqgodjtwkikbbida";
    // 发件人邮箱服务地址-修改为自己的
    ...
    public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException {
        ...
        // 2、From：发件人
        message.setFrom(new InternetAddress(sendMail, "美女", "UTF-8"));
