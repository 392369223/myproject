        ...
        <div class="r_nav">
            <ul>
                <li>
                    ...
                    {%>
                    <label><b><%=session.getAttribute("uname")%></b></label>
                    <%}else{%>
                ...
                <li>
                    ...
                    <label>
                        <img src="./image/mslb.png">
                    </label>
                </li>
                <li>
                    <a href="modify"><label>修改个人信息</label></a>
                    <label>
                        <img src="./image/grxx.png">
                    </label>
                </li>
                <li class="line"></li>
                <li>
...
<div class="m_nav w">
    ...
    <div class="search_box">
        ...
        <input type="text" class="search" placeholder="伟大的中国" autofocus>&nbsp;
    ...
    <div class="main_body w">
        <div class="banner">
            ...
            <%--<div class="middle_banner cc mycc">--%>
                <%--<%--%>
                    <%--List<Book> books=(ArrayList<Book>)session.getAttribute("books");--%>
                    <%--for(Book book:books){%>--%>
                <%--<a href="purchase?bookid=<%=book.getId()%>&salename=<%=book.getSaler()%>--%>
                <%--&bookname=<%=book.getName()%>&path=<%=book.getPath()%>&num=<%=book.getCount()%>"--%>
                   <%--target="_blank" style="display: flex;align-items: center;flex-direction: column">--%>
                    <%--<img src="<%=book.getPath()%>" width="200px" height="300px">--%>
                    <%--<p><%=book.getName()%>&nbsp;&nbsp;<%=book.getPrise()%></p>--%>
                        <%--<%--%>
                       <%--};--%>
                        <%--%>--%>
            <%--</div>--%>
